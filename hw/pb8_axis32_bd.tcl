...
################################################################
# This is a generated script based on design: pb8_axis32
#
...
CONFIG.NUM_PORTS {16} \
  ...
  set zdma_core_0 [ create_bd_cell -type ip -vlnv tuc:hls:zdma_core:2.6 zdma_core_0 ]

  # Create instance: zdma_core_1, and set properties
  set zdma_core_1 [ create_bd_cell -type ip -vlnv tuc:hls:zdma_core:2.6 zdma_core_1 ]

  # Create instance: zdma_core_2, and set properties
  set zdma_core_2 [ create_bd_cell -type ip -vlnv tuc:hls:zdma_core:2.6 zdma_core_2 ]

  # Create instance: zdma_core_3, and set properties
  set zdma_core_3 [ create_bd_cell -type ip -vlnv tuc:hls:zdma_core:2.6 zdma_core_3 ]

  # Create instance: zdma_core_4, and set properties
  set zdma_core_4 [ create_bd_cell -type ip -vlnv tuc:hls:zdma_core:2.6 zdma_core_4 ]

  # Create instance: zdma_core_5, and set properties
  set zdma_core_5 [ create_bd_cell -type ip -vlnv tuc:hls:zdma_core:2.6 zdma_core_5 ]

  # Create instance: zdma_core_6, and set properties
  set zdma_core_6 [ create_bd_cell -type ip -vlnv tuc:hls:zdma_core:2.6 zdma_core_6 ]

  # Create instance: zdma_core_7, and set properties
  set zdma_core_7 [ create_bd_cell -type ip -vlnv tuc:hls:zdma_core:2.6 zdma_core_7 ]
