...
\item	In UltraScale+, if the initial \gls{rm} configuration succeeds placement and routing but 
	the subsequent fails at placement due to unavailable 
	\gls{bram} or \gls{dsp} tiles,
...
resources instead of \glspl{clb} for implementing integer multiplication 
...
in order to achieve timing closure.
