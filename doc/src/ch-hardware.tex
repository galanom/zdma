...
\begin{tikzpicture}
	...
	\node[emptyblock, gray, very densely dashed, anchor=north west, minimum width=50mm, minimum height=28mm]
		(axi-int) at ($(int0.north west) + (-5mm, 12mm)$) {};
	...
	% APU
	\node[block, minimum width = 20mm, minimum height = 12mm, anchor = north west] (apu)
	...
	\node[block, minimum width = 25mm, minimum height = 12mm, anchor=west] (central-interconnect) 
		at ($(apu.east) + (5mm,0)$) {Central\\Interconnect};
	\draw[axi64] (central-interconnect) -- (central-interconnect |- master-interconnect.south);
	...
	\node[emptyblock, gray, very densely dashed, anchor=north west, minimum width=30mm, minimum height=28mm]
		(axilite-int) at ($(per-int0.north west) + (-5mm, 12mm)$) {};
...
%		node[above left]{\ttfamily\scriptsize 16}
	...
	\draw[maxil] (per-int0) 
		...
		node[above right = 0mm and 4mm]{\ttfamily \textcolor{black}{11..15}}
	...
	\draw[maxil] (per-int1) 
		...
		node[above right = 0mm and -7mm]{\ttfamily \textcolor{black}{11..15}}
