...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_SDIO0_REF_CTRL_DIVISOR0                         0x1e
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E006C, 0x013F3F07U ,0x01011E02U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_SDIO1_REF_CTRL_DIVISOR0                         0x1e
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0070, 0x013F3F07U ,0x01011E02U)
    */
...
/*##################################################################### */
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00A4, 0x01003F07U ,0x01000902U)
    */
	PSU_Mask_Write(CRL_APB_PCAP_CTRL_OFFSET, 0x01003F07U, 0x01000902U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(CRF_APB_DBG_TRACE_CTRL_OFFSET,
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_26_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_27_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_28_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_29_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_30_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_31_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_32_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_33_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_34_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_35_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_36_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_37_OFFSET, 0x000000FEU, 0x00000002U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_76_OFFSET, 0x000000FEU, 0x00000060U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_77_OFFSET, 0x000000FEU, 0x00000060U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x00000000U)
    */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B0263FU)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00B0263FU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18014C, 0x03FFFFFFU ,0x00FFE000U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL6_OFFSET,
		0x03FFFFFFU, 0x00FFE000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180168, 0x03FFFFFFU ,0x03F00000U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL6_OFFSET,
		0x03FFFFFFU, 0x03F00000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * SD eMMC selection
    * (OFFSET, MASK, VALUE)      (0XFF180310, 0x00008001U ,0x00000001U)
    */
	PSU_Mask_Write(IOU_SLCR_CTRL_REG_SD_OFFSET,
		0x00008001U, 0x00000001U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180320, 0x33803380U ,0x00801280U)
    */
	PSU_Mask_Write(IOU_SLCR_SD_CONFIG_REG2_OFFSET,
		0x33803380U, 0x00801280U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_SD_CONFIG_REG1_SD0_BASECLK                     0x32
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18031C, 0x00007FFEU ,0x00001950U)
    */
	PSU_Mask_Write(IOU_SLCR_SD_CONFIG_REG1_OFFSET,
		0x00007FFEU, 0x00001950U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Base Clock Frequency for SD Clock. This is the frequency of the xin_clk.
    *  PSU_IOU_SLCR_SD_CONFIG_REG1_SD1_BASECLK                     0x32
    ...
    * SD Config Register 1
    * (OFFSET, MASK, VALUE)      (0XFF18031C, 0x7FFE0000U ,0x19500000U)
    */
	PSU_Mask_Write(IOU_SLCR_SD_CONFIG_REG1_OFFSET,
		0x7FFE0000U, 0x19500000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
    /*
    * Register : LAR @ 0XFE980FB0

    * A write of 0xC5ACCE55 enables further write access to this device. A wri
    * te of any value other than 0xC5ACCE55 will have the affect of removing w
    * rite access.
    *  PSU_TPIU_LAR_ACCESS_W                                       0XC5ACCE55

    * This is used to enable write access to device registers. External access
    * es from a debugger (paddrdbg31 = 1) are not subject to the Lock Register
    * s. A debugger does not have to unlock the component in order to write an
    * d modify the registers in the component.
...
/*##################################################################### */
    ...
    */
    /*
    * Register : Current_port_size @ 0XFE980004

    * Indicates whether the current port size of the TPIU is 16 bits.
    *  PSU_TPIU_CURRENT_PORT_SIZE_PORT_SIZE_16                     1

    * The Current Port Size Register has the same format as the Supported Port
    *  Sizes register but only one bit is set, and all others must be zero. Wr
    * iting values with more than one bit set or setting a bit that is not ind
    * icated as supported is not supported and causes unpredictable behavior.O
    * n reset this defaults to the smallest possible port size, 1 bit, and so
    * reads as 0x00000001.Note : Do not modify the value while the Trace Port
    * is still active, or without correctly stopping the formatter (see Format
    * ter and Flush Control Register, 0x304). This can result in data not bein
    * g aligned to the port width. For example, data on an 8-bit Trace Port mi
    * ght not be byte aligned.
    * (OFFSET, MASK, VALUE)      (0XFE980004, 0x00008000U ,0x00008000U)
    */
	PSU_Mask_Write(TPIU_CURRENT_PORT_SIZE_OFFSET,
...
/*##################################################################### */
    ...
    */
    /*
    * Register : EXTCTL_Out_Port @ 0XFE980404

    * EXTCTL Outputs. Bits [7:1] are not used; bit [0] controls the source for
    *  TPIU trace clock: 0: trace clock is from PS clock controller 1: trace c
    * lock is from PL
    *  PSU_TPIU_EXTCTL_OUT_PORT_EXTCTLOUT                          1

    * Two ports can be used as a control and feedback mechanism for any serial
    * izers, pin sharing multiplexors or other solutions that might be added t
    * o the trace output pins either for pin control or a high speed trace por
    * t solution. These ports are raw register banks that sample or export the
    *  corresponding external pins. The output register bank is set to all zer
    * os on reset. The input registers sample the incoming signals and as such
    *  are undefined.
    * (OFFSET, MASK, VALUE)      (0XFE980404, 0x000000FFU ,0x00000001U)
    */
	PSU_Mask_Write(TPIU_EXTCTL_OUT_PORT_OFFSET,
...
/*##################################################################### */
    ...
    *  PSU_SERDES_L0_L3_REF_CLK_SEL_L3_REF_CLK_SEL_2               0x1

    * Lane3 Ref Clock Selection Register
    * (OFFSET, MASK, VALUE)      (0XFD40286C, 0x00000084U ,0x00000004U)
    */
...
/*##################################################################### */
    ...
    *  PSU_USB3_0_XHCI_GCTL_U1U2TIMERSCALE                         0x1

    * Global Core Control Register Refer to <workspace>/src/DWC_usb3_params.v
    * for details on `DWC_USB3_GCTL_INIT. Note: When Hibernation is not enable
    * d, you can write any value to GblHibernationEn. It always returns 0 when
    *  read.
    * (OFFSET, MASK, VALUE)      (0XFE20C110, 0x00000200U ,0x00000200U)
    */
	PSU_Mask_Write(USB3_0_XHCI_GCTL_OFFSET, 0x00000200U, 0x00000200U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    /*
    * Register : GCTL @ 0XFE30C110

    * Disable U1/U2 timer Scaledown (U1U2TimerScale). If set to '1' along with
    *  GCTL[5:4] (ScaleDown) = 2'bX1, disables the scale down of U1/U2 inactiv
    * e timer values. This is for simulation mode only.
    *  PSU_USB3_1_XHCI_GCTL_U1U2TIMERSCALE                         0x1

    * Global Core Control Register Refer to <workspace>/src/DWC_usb3_params.v
    * for details on `DWC_USB3_GCTL_INIT. Note: When Hibernation is not enable
    * d, you can write any value to GblHibernationEn. It always returns 0 when
    *  read.
    * (OFFSET, MASK, VALUE)      (0XFE30C110, 0x00000200U ,0x00000200U)
    */
	PSU_Mask_Write(USB3_1_XHCI_GCTL_OFFSET, 0x00000200U, 0x00000200U);
/*##################################################################### */
