...
\subsection{Physical Considerations and Floorplanning}
...
\subfloat[Successful timing closure in static workflow but not in PR.]%
	{\includegraphics[scale=.45]{img/design1-floorplan-pr.pdf}}
\\
\subfloat[Successful timing closure in PR workflow but not in static.]%
	{\includegraphics[scale=.45]{img/design1-floorplan-static.pdf}}
\caption{Routability of a design in the static workflow \\
	does not imply routability in the PR workflow, and vice versa.}
\end{figure}
...
will be presented in section \emph{[TODO περιγραφή software]}.
