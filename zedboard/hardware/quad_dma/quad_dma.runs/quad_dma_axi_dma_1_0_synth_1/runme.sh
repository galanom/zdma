...
HD_PWD='/home/igalanommatis/work/zdma/zedboard/hardware/quad_dma/quad_dma.runs/quad_dma_axi_dma_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log quad_dma_axi_dma_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source quad_dma_axi_dma_1_0.tcl
