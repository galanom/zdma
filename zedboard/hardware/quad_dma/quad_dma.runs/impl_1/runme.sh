...
HD_PWD='/home/igalanommatis/work/zdma/zedboard/hardware/quad_dma/quad_dma.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log quad_dma_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source quad_dma_wrapper.tcl -notrace
