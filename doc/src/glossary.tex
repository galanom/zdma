\newglossaryentry{dt}
{
	...
	description = {
		...
		originally developed by Sun for the \glsentrylong{of} system.
	},
}
...
\newglossaryentry{fdt}
{
	...
	first = {\glsentrylong{fdt} (\glsentryname{fdt})},
	description = {
		A \glsentrylong{dt} representation used by Linux that may also be
		passed to the kernel by the bootloader, thus supporting systems
		that do not implement \glsentrylong{of}.
	},
	see = {dt,of},
}
...
\newglossaryentry{dto}
{
	...
	first = {\glsentrylong{dto} (\glsentryname{dto})},
	description = {
		An extension to the \glsentrylong{fdt} that allows the dynamic (run-time) modification
		of the kernel's live \glsentrylong{dt}.
	},
	see = {dt},
}
...
\newglossaryentry{vfs}
{
	...
	description = {\glsentrylong{vfs} (\glsentryname{vfs}),
