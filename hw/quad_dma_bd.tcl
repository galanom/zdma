...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axis_data_fifo_0_axis_data_count [get_bd_pins axis_data_fifo_0/axis_data_count] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins debug_0/core1] [get_bd_pins xlslice_0/Dout]
