...
set psu_pll_init_data {
    ...
    mask_write 0XFF5E0034 0xFE7FEDEF 0x7E4B0C82
		# : UPDATE FB_DIV
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E006C 0x013F3F07 0x01011E02
    ...
    mask_write 0XFF5E0070 0x013F3F07 0x01011E02
    ...
    mask_write 0XFF5E00A4 0x01003F07 0x01000902
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD080040 0xFFFFFFFF 0x0AC85590
    ...
    mask_write 0XFD080044 0xFFFFFFFF 0x41540B00
...
set psu_mio_init_data {
    ...
    mask_write 0XFF1800A8 0x000000FE 0x000000C0
    ...
    mask_write 0XFF1800AC 0x000000FE 0x000000C0
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x00000000
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B0263F
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x00FFE000
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x03F00000
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF5E023C 0x00000FC0 0x00000000
		# : SD
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
    ...
    mask_write 0XFF180310 0x00008001 0x00000001
    ...
    mask_write 0XFF180320 0x33803380 0x00801280
		# : SD0 BASE CLOCK
    ...
    mask_write 0XFF18031C 0x00007FFE 0x00001950
    ...
    mask_write 0XFF18031C 0x7FFE0000 0x19500000
		# Register : SD_DLL_CTRL @ 0XFF180358</p>
    ...
    mask_write 0XFE980FB0 0xFFFFFFFF 0xC5ACCE55
    ...
    mask_write 0XFE980004 0x00008000 0x00008000
		# : TRACE PORT SOURCE
		# Register : EXTCTL_Out_Port @ 0XFE980404</p>
    ...
    mask_write 0XFE980404 0x000000FF 0x00000001
		# : TRACE LOCK ACCESS REGISTER
		# Register : LAR @ 0XFE980FB0</p>
    ...
    mask_write 0XFE980FB0 0xFFFFFFFF 0x00000000
		# : UART BAUD RATE
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD40286C 0x00000084 0x00000004
    ...
    mask_write 0XFD40E368 0x000000FF 0x00000038
    ...
    mask_write 0XFD40E370 0x000000FF 0x000000F4
    ...
    mask_write 0XFD40E374 0x000000FF 0x00000031
    ...
    mask_write 0XFD40E378 0x000000FF 0x00000002
    ...
    mask_write 0XFD40D8F8 0x000000FF 0x0000001A
    ...
    mask_write 0XFD40D8FC 0x000000FF 0x0000001A
    ...
    mask_write 0XFD40D900 0x000000FF 0x0000001A
...
set psu_resetout_init_data {
    ...
    mask_write 0XFE20C110 0x00000200 0x00000200
		# : USB1 GFLADJ
    ...
    mask_write 0XFE30C11C 0x00000400 0x00000400
		# Register : GCTL @ 0XFE30C110</p>
    ...
    mask_write 0XFE30C110 0x00000200 0x00000200
