...
The ARM's proposal is the \gls{amba} protocol suite
...
%It proved to do so in our memoryless accelerators,
%but it did not on the ones containing a BRAM implemented line buffer (see figure \ref{fig:acc-util}). Additionally,
%the increase of accelerator data width does not cause only the increase of the partition size but also of the interface wire count.
