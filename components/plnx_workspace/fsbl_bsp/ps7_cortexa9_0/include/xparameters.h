...
#define XPAR_AXI_BRAM_CTRL_1_DEVICE_ID 0
...
#define XPAR_AXI_BRAM_CTRL_1_S_AXI_HIGHADDR 0x40001FFF
...
#define XPAR_BRAM_0_DEVICE_ID XPAR_AXI_BRAM_CTRL_1_DEVICE_ID
